...
TRANSLATIONS = {
    "zh": {
        ...
        "time_offset_help": "如果影片比實際下潛早開始，請用正值調整。",
        "layout_select_label": "選擇影片版型",
        "layout_preview_title": "版型示意圖（暫時只有Layout B可以用）",
    ...
    "en": {
        ...
        "tooltip_rate": "Smoothed speed (|m/s|)",
        ...
        "time_offset_help": "If the video starts before the actual dive, use a positive offset.",
